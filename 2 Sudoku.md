...
## 2-4.Generating permutations(this section is same as Eight Queen)
...
## 2-5.Selecting solutions from whole permutations
...
## 2-6.Combinating and checking all the rows
